...
sbAdminApp.run(function ($rootScope, $localStorage, $state, apis, $http, userMeService) {
    ...
    if (!$rootScope.geoLocations.lat) {
        ...
        /*if (navigator.geolocation) {
         ...
         $rootScope.geoLocations.lat = position.coords.latitude;
         $rootScope.geoLocations.lng = position.coords.longitude;
         geocoder.geocode({
         'latLng': {
         ...
         $rootScope.geoLocations.country_name = address_component.address_components[0].long_name;
         $rootScope.geoLocations.country_code = address_component.address_components[0].short_name;
         }
         });
         }
...
sbAdminApp.controller("appCtrl", function ($rootScope, $scope, $state, $http, $localStorage, $interval, $log) {
